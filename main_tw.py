...
print("3. 輸入完發送次數會有兩秒的緩衝時間，請在此兩秒內點擊你要發送的窗口")
print("4. 支持Windows，可能支持macOS，可以試試看，為什麼是可能去問賈勃斯")
print("5. 不想玩了直接關掉就好，想看源碼我有上傳到YT：https://www.youtube.com/watch?v=dQw4w9WgXcQ")
